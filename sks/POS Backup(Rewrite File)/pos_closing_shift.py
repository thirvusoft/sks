...
def submit_closing_shift(closing_shift):
    ...
    for i in range(0,len(ts_payment_reconciliation),1):
        ...
        print(ts_mode_of_payment_type.type)
    ...
    closing_shift_doc.save()
    ts_pos_opening_shift=frappe.get_doc("POS Opening Shift",closing_shift_doc.pos_opening_shift)
    ts_pos_opening_shift.ts_pos_closing_shift_created=1
    ts_pos_opening_shift.save()
    ts_pos_opening_shift.submit()
    # End
