      ...
      return frappe
        ...
        .then((r) => {
          if (r.message) {
            ...
            // Start
            if(r.message["pos_opening_shift"]["ts_pos_closing_shift_created"]==1){
            var d = new frappe.ui.Dialog({
                title: "POS Closing Shift Not Submitted By Authority People, Please Contact Them To Access The Thirvu Retail",
