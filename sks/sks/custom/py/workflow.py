...
def create_rate_changer_from_purchase_order():
    ...
    workflow.append('transitions', dict(
        ...
        allowed='Purchase User', allow_self_approval= 1,condition="doc.ts_item_price_changed==1"
    ))
    workflow.append('transitions', dict(
        state = 'Approval Pending', action='Approve', next_state = 'Approved',
        allowed='Purchase Manager', allow_self_approval= 1,condition="doc.ts_item_price_changed==1"
    ))
    workflow.append('transitions', dict(
    ...
    workflow.append('transitions', dict(
        ...
        allowed='Purchase User', allow_self_approval= 1,condition="doc.ts_item_price_changed==0"
    ))
